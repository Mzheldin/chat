...
public class ClientHandler implements Closeable {
    ...
    public ClientHandler(Socket socket, Server server) {
        ...
        try {
            ...
            log.log(Level.ALL, "Ошибка при подключении клиента", e);
        }
    }
    ...
    private void process() {
        ...
        while (socket.isConnected()) {
            ...
            switch (msg.getType()) {
                ...
                default:
                    log.info(msg.getType().name() + " - invalid message type");
            }
        }
    }
    ...
    private void auth() {
        while (true) {
            ...
            if (MessageType.AUTH_MESSAGE.equals(message.getType())) {
                ...
                log.info(message.getType().name() + " - invalid command before auth!");
            }
        }
    }
